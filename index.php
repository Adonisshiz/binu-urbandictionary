<?php
	...
	$app_config = array (
		...
		'app_id' => 5732,								// Your DevCentral application ID goes here
		'app_name' => 'Urban Dictionary',				// Your application name goes here
		'app_home' => 'http://binu-urbandictionary.azurewebsites.net/',	// Publically accessible URI
	...
	try {
		...
		$binu_app->add_text("Click on a letter (or number) below to browse by letter (or number)",'body_text');
	 	$binu_app->add_link("letter.php?letter=1&amp;pageNum_wordsRecordset=0" , "1", "intro");
		$binu_app->add_link("letter.php?letter=2&amp;pageNum_wordsRecordset=0" , "2", "intro");
		$binu_app->add_link("letter.php?letter=3&amp;pageNum_wordsRecordset=0" , "3", "intro");
		$binu_app->add_link("letter.php?letter=4&amp;pageNum_wordsRecordset=0" , "4", "intro");
		$binu_app->add_link("" , "", "intro");
